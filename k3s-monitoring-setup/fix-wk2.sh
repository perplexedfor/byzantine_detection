#!/bin/bash
# =============================================================================
# fix-wk2.sh — Apply infra-level stall fixes on sw-wk2 (192.168.56.11)
# Run as: sudo bash fix-wk2.sh   (must be executed ON sw-wk2 via SSH)
# =============================================================================
set -euo pipefail

echo "====== [fix-wk2] Starting fixes on $(hostname) ======"
